...
def save_data(sheet_name, data):
    ...
    try:
        ...
        st.error(f"Błąd zapisu do Arkusza Google: {e}")
    ...
    if st.session_state.rola == 'szef':
            ...
            if not zam_data:
                ...
                for z in zam_data:
                    with st.expander(f"ZAM: {z['nr']}  |  Wymagany termin: {z.get('termin', 'Brak')}"):
                        ...
                        if z.get('pdf_base64'): info_text += "<br><span style='color:#1e3a8a;'>📄 Etykieta zapisana w chmurze</span>"
        ...
        with t3:
            ...
            if not hist_data:
                ...
                with st.expander("⚙️ Zaawansowana edycja bazy"):
        ...
        with t5:
            st.markdown("#### Obsługa Zwrotów (RMA)")
